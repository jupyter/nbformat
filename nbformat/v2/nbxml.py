...
REMOVED_MSG = """\
Reading notebooks as XML has been removed as security issues were discovered.
...
removed it rather than trying to fix the problems.
...
The issue which prompted its removal is:
